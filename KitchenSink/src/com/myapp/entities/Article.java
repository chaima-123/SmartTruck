...
public class Article {
    ...
    public Article(String ref_article, String designation, String code, float prix_achat, float prix_vente, String unité, int seuil_min, int seuil_max, int fournisseur, Famille famille) {
    ...
    public String toString() {
        return "Article{" + "ref_article=" + ref_article + ", designation=" + designation + ", code=" + code + ", prix_achat=" + prix_achat + ", prix_vente=" + prix_vente + ", unit\u00e9=" + unité + ", img=" + img + ", seuil_min=" + seuil_min + ", seuil_max=" + seuil_max + ", fournisseur=" + fournisseur + ", famille=" + famille + '}';
    }
