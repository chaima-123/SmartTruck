...
public class DemoComponent extends Container {
    ...
    DemoComponent(String displayName, Image demoIcon, Object imageMask, Image colorBottom, Object circleMask, Image image, int circleMaskWidth, int circleMaskHeight, String string) {
    }
