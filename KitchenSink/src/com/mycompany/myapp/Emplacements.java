...
import com.esprit.gui.AddAlleeForm;
import com.esprit.gui.AffecterFamille;
import com.esprit.gui.HomeForm;
import com.esprit.gui.ListAlleeForm;
import com.esprit.gui.ListEmpForm;
import com.esprit.gui.apiCapture;
 ...
 * @author Shai Almog
 */
public class Emplacements extends Demo {    
    ...
    public Image getDemoIcon() {
        Image imageEmplacement = null;
        try {
            imageEmplacement = Image.createImage("/emplacements.jpg");
            return imageEmplacement;
    ...
    public String getDescription() {
        return "La gestion des Livreurs: cette rubrique permet d'ajouter afficher modifier et supprimer un livreur";
    }
    ...
    public Container createDemo(Form parentForm) {
        ...
        Button livreurs = new Button("Gestion des Allées");
        livreurs.addActionListener(e -> new HomeForm().show());
        
         cn.add(new Label("Choisissez une option"));
        ...
        btnListTasks.addActionListener(e -> new ListAlleeForm(parentForm).show());
        btnAddTask.addActionListener(e -> new AddAlleeForm(parentForm).show());
        btnListEmp.addActionListener(e -> new ListEmpForm(parentForm).show());
        b.addActionListener(e -> new apiCapture(parentForm).show());
        //f.addActionListener(e -> new GestionFamille(current).show());
        affFam.addActionListener(e -> new AffecterFamille(parentForm).show());

        btnListTasks.getAllStyles().setBorder(Border.createGrooveBorder(CENTER, 0xe16702));
        btnListTasks.getAllStyles().setFgColor(0xe16702);
        btnListTasks.getAllStyles().setBackgroundGradientEndColor(0xe16702);

        btnAddTask.getAllStyles().setBorder(Border.createGrooveBorder(CENTER, 0xe16702));
        btnAddTask.getAllStyles().setFgColor(0xe16702);
        btnAddTask.getAllStyles().setBackgroundGradientEndColor(0xe16702);

        btnListEmp.getAllStyles().setBorder(Border.createGrooveBorder(CENTER, 0xe16702));
       ...
       btnListEmp.getAllStyles().setBackgroundGradientEndColor(0xe16702);
        ...
        b.getAllStyles().setBorder(Border.createGrooveBorder(CENTER, 0xe16702) );
        b.getAllStyles().setFgColor(0xe16702);
        b.getAllStyles().setBackgroundGradientEndColor(0xe16702);
       
        affFam.getAllStyles().setBorder(Border.createGrooveBorder(CENTER, 0xe16702));
