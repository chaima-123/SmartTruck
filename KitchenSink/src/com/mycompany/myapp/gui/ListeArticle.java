...
//                    System.out.println(art.getDesignation());
                    ...
                    try {
                       ...
                       String  url = "http://localhost/"+art.getImg();
                       ...
                       float prx = art.getPrix_vente();
                        Label l= new Label( (art.getRef_article()));
                    ...
                    Dialog.show("Alert", "Il faut saisir une quantite");
             
        {
                                            Dialog.show("Success", "commande ajoutée", new Command("OK"));

                     //java.sql.Date.valueOf( dateP.getValue()),
                        LigneCommande t = new LigneCommande(Integer.parseInt( tf.getText()),l.getText() );
                        if( ServiceArticle.getInstance().addcommande(t))
